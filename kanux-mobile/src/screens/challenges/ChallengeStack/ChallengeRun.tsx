...
export const SoftChallengeExecutionScreen: React.FC = () => {
  const navigation =
    useNavigation<NativeStackNavigationProp<ChallengesStackParamList>>();
        ...
        <View style={styles.mainContainer}>
            ...
            {currentQuestion?.non_technical_question_options?.map((opt) => {
              ...
              return (
                <TouchableOpacity
                  ...
                  onPress={() =>
                    currentQuestion && selectOption(currentQuestion.id, opt.id)
                  }
                >
                  <View
                    style={[
          ...
          <View style={styles.footerNav}>
            <TouchableOpacity
              ...
              style={[
                styles.navAction,
                currentStep === 0 && styles.navActionDisabled,
              ]}
            >
              <ChevronLeft
                size={20}
                color={currentStep === 0 ? "#cbd5e1" : colors.primary}
              />
              <Text
                style={[
                  styles.navActionText,
                  currentStep === 0 && styles.navActionTextDisabled,
                ]}
              >
                Anterior
              </Text>
            ...
            <TouchableOpacity
              ...
              style={[
                styles.navAction,
                currentStep === totalQuestions - 1 && styles.navActionDisabled,
              ]}
            >
              <Text
                style={[
